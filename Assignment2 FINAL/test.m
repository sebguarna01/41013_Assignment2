...
% Cup filling
aboveCup = [0, pi/4, pi/4, 0, -pi/2, -pi/2];    % above mixer 3
pourDrink = [0, pi/4, pi/4, 0, -pi/2, pi/2];    % mixer 3 offset

%% Run drink Making functions 

makeVodkaLemonade(IRB1200, aboveBottle2, Bottle2, aboveMixer2, Mixer2, aboveCup, pourDrink, gripperR, gripperL, numSteps);
pause(2);
makeWhiskeyANDCoke(IRB1200, aboveBottle3, Bottle3, aboveMixer1, Mixer1, aboveCup, pourDrink, gripperR, gripperL,numSteps);
pause(2);
makeVodkaOJ(IRB1200, aboveBottle2, Bottle2, aboveMixer3, Mixer3, aboveCup, pourDrink, gripperR, gripperL,numSteps);
pause(2);
...
function makeVodkaLemonade(IRB1200, aboveBottle2, Bottle2, aboveMixer2, Mixer2, aboveCup, pourDrink, gripperR, gripperL, numSteps)
    ...
    posesVodkaLemonade = [
        ...
        Bottle2;
        aboveBottle2;
        aboveCup;     % above 'cup home'
        pourDrink;      % pour drink
        aboveCup;     % above 'cup home'
        aboveBottle2;
        Bottle2;
        aboveBottle2;
